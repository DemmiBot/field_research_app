...
import com.example.fieldpolling.dtos.ResearchRecordDto;
import com.example.fieldpolling.models.Poll;
import com.example.fieldpolling.repositories.ResearchRepository;
...
public class ResearchController {
    ...
    public ResponseEntity<Poll> saveResearch(@RequestBody @Valid ResearchRecordDto researchRecordDto) {
        var researchModel = new Poll();
    ...
    public ResponseEntity<List<Poll>> getAllResearches() {
    ...
    public ResponseEntity<Object> getOneResearch(@PathVariable(value="id") UUID id ) {
        Optional<Poll> researchO = researchRepository.findById(id);
